...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr/local/net-snmp'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/usr/local/net-snmp/share/snmp/mibs"
...
#define SNMPLIBPATH "/usr/local/net-snmp/lib/snmp"
#define SNMPSHAREPATH "/usr/local/net-snmp/share/snmp"
#define SNMPCONFPATH "/usr/local/net-snmp/etc/snmp"
#define SNMPDLMODPATH "/usr/local/net-snmp/lib/snmp/dlmod"
...
#define NETSNMP_SYS_CONTACT "2548316823@qq.com"
